...
void load_EN_AC_text()
{
    ...
    //Credits
    game.autochase_text.credits.credits[CREDIT_LINE_CREATED_BY]="Created By:";
    game.autochase_text.credits.credits[CREDIT_LINE_DEVELOPER]="Developed By:";
    game.autochase_text.credits.credits[CREDIT_LINE_MUSIC_BY]="Music By:";
    game.autochase_text.credits.credits[CREDIT_LINE_TESTER]="Testers:";
    game.autochase_text.credits.credits[CREDIT_LINE_TESTER_MAC]="Mac Testers:";
    game.autochase_text.credits.credits[CREDIT_LINE_TESTER_WIN]="Windows Testers:";
    game.autochase_text.credits.credits[CREDIT_LINE_TESTER_LINUX]="Linux Testers:";
    //Are You Ready
    ...
    game.autochase_text.error_text.create_player="There was an internal error creating the player, verify the"\
                                                ...
                                                CARS_SPRITE_PATH;
    game.autochase_text.error_text.create_enemies="There was an internal error creating the enemies, verify the"\
                                                " existence of images in the following directory: "\
                                                ENEMIES_PATH;
    ...
    //End Game
    game.autochase_text.end_game.end_game_label="Game Over";
    game.autochase_text.end_game.new_game_option="Enter - New Game";
    game.autochase_text.end_game.exit_game_option="Esc - Exit Game";
}
